...
طرح کلی نقاشی داخل یک فریم کشیده شده است. ساخت فریم با دستورات حرکت و تغییر زاویه در تابع رسم شده که در نهایت فریم به شکل یک مستطیل در امده است.
نقاشی غروب ساحل شامل بخش های مختلفی از جمه علفزار، درخت ها، خورشید، ابرها، پرندگان و دریا است.
 اسمان، دریا و ساحل به کمک رسم مستطیل هایی به ابعاد مشخص و رنگ امیزی انها رسم شده اند.
...
برای اینکه بخش هایی از نقاشی رنگ های رندوم اما نزدیک به هم بگیرند متغیری تعریف شده و محدوده رنگ های مطلوب به ان نسبت داده شده تا رنگ ها به صورت رندوم از مجموعه مورد نظر انتخاب شوند.
